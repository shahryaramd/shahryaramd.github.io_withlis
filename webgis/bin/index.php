...
<!-- /////////////// -->
  ...
  <body>
    ...
    <div id="element_to_pop_up0">
        <a class="b-close"><img src="X.png" height="10px" width="10"></a>
  	    <div id="login-form">
      		<form method="post">
          <h3 align="center">Enter Your Credentials </h3>
      		<input type="text" name="email" placeholder="Your Email" class="eventinfo" required /><br>
      		<input type="password" name="pass" placeholder="Your Password" class="eventinfo" required /><br>
      		<button type="submit" class="mui-btn mui-btn--raised mui-btn--primary" name="btn-login">Sign In</button></td>
      		<br>
    ...
    <div style="">
          <img src="globe3d.png" style="z-index: -1; position:fixed; height:85px;width:85px;left:20px;top:20px;">
          <H2 style="position: absolute; z-index: 2;top:20px;padding-left:100px; 
    ...
    <div id="reg-buttons" align="right">
      <button  id="login-button" class= "mui-btn mui-btn--small mui-btn--primary mui-btn--flat"> <i class="fa fa-sign-in"></i>&nbsp;Sign In</button>
      <button  id="register-button" class= "mui-btn mui-btn--small mui-btn--primary mui-btn--flat"  onclick="location.href='register.php';"> <i class="fa fa-user"></i>&nbsp;Register</button>
    </div>
              ...
              <div class="sidebar-content">
                  ...
                  <div class="sidebar-pane" id="fb">
                      <h1 class="sidebar-header">Interior Navigation<div class="sidebar-close"><i class="fa fa-caret-left"></i></div></h1>
                        <div id="fbtext" class="mui-container">
                          ...
                          <button id="my-button" class= "mui-btn mui-btn--raised mui-btn--accent"> <i class="fa fa-street-view"></i>Start Navigating FB</button>
                  ...
                  <div class="sidebar-pane" id="shutdown">
                      ...
                      <h1 class="sidebar-header">Shutdown Notifications<div class="sidebar-close"><i class="fa fa-caret-left"></i></div></h1>
                        ...
                        <br><br>
                         <p> <i class="fa fa-lock" aria-hidden="true"></i> Please Sign-In to add a shutdown !</p>
                  ...
                  <!-- Events -->
                   <div class="sidebar-pane" id="events">
                      ...
                      <br><br>
                      <p> <i class="fa fa-lock" aria-hidden="true"></i> Please Sign-In to add an Event !</p>
                  ...
                  <!-- Lost and found -->
                   <div class="sidebar-pane" id="lnf">
                      ...
                      <br><br>
                      <p> <i class="fa fa-lock" aria-hidden="true"></i> Please Sign-In to add an Object !</p>
                      
                      <br>
                      <form name="form4" style="display:none;">
