...
function mapInit() {
  ...
  if (region.selectedIndex == 0) {
    ...
    if (strForcing == 'rg_d') {
      var imgdata = 'DATA_DIR/tile/' + strRegion + '/' + strModel + '/rg/daily/' + strDataset + '/' + yearpick + '/' + datepick + '.png';
    } else if (strForcing == 'rg_m') {
      var imgdata = 'DATA_DIR/tile/' + strRegion + '/' + strModel + '/rg/monthly/' + strDataset + '/' + yearpick + '/' + datepick + '.png';
    } else if (strForcing == 'cm_m') {
      var imgdata = 'DATA_DIR/tile/' + strRegion + '/' + strModel + '/cm/monthly/' + strDataset + '/' + yearpick + '/' + datepick + '.png';
    } else if (strForcing == 'gdas') {
      var imgdata = 'DATA_DIR/tile/' + strRegion + '/' + strModel + '/gdas/daily/' + strDataset + '/' + yearpick + '/' + datepick + '.png';
      var imgdata = 'DATA_DIR/tile/' + strRegion + '/' + strModel + '/gdas/daily/' + strDataset + '/' + yearpick + '/' + datepick + '.png';
    }
