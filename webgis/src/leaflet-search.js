...
L.Control.Search = L.Control.extend({
	...
	options: {
		...
		zoom: 17,					//zoom after pan to location found, default: map.getZoom()
		position: 'topleft',
...
//	in this way every record can have a free structure of attributes, only 'loc' is required
	...
	showLocation: function(latlng, title) {	//set location on map from _recordsCache
		document.getElementsByName('searchbox').value=title;		//my modified for list box title
		...
		if(this._markerLoc)
		{
			...
			this._markerLoc.bindPopup(title);	//my modified
