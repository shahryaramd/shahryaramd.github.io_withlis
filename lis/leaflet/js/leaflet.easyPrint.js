...
function printPage() {
    if (this.options.elementsToHide) {
        ...
        for (var i = 0; i < htmlElementsToHide.length; i++) {
            ...
            if (htmlElementsToHide[i].className === 'hidePrint' || htmlElementsToHide[i].className == 'leaflet-control-zoom leaflet-bar leaflet-control') {
                //alert(htmlElementsToHide[i].className);
